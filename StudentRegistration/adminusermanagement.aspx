<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminusermanagement.aspx.cs" Inherits="StudentRegistration.adminusermanagement" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-md-5">
                        <label>NIC</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox5" runat="server" placeholder="NIC" ReadOnly="True"></asp:TextBox>
                        </div>
                     </div>
                  </div>
         ...
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:studentRegistrationConnectionString %>" SelectCommand="SELECT * FROM [student_master_tbl]"></asp:SqlDataSource>
                     <div class="col">
                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="username" DataSourceID="SqlDataSource1">
                            <Columns>
                                <asp:BoundField DataField="registration_number" HeaderText="Registration No" SortExpression="registration_number" />
